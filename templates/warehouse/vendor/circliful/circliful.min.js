...
!function (t) {
    t.fn.circliful = function (e, o) {
        ...
        return this.each(function () {
            var e, o, n, i = t(this), c = r.percent, l = 83, a = 100, s = 110, d = 100, x = r.backgroundBorderWidth;
            ...
            var g = i.find(".circle"), k = i.find(".timer"), f = 30, u = 0, y = r.animationStep, h = 0, C = 0, p = 0;
            ...
            }.bind(g), f); else g.attr("stroke-dasharray", 3.6 * c + ", 20000"), 1 == r.showPercent ? k.text(c + "%") : k.text(r.target)
        })
    }
}(jQuery);
